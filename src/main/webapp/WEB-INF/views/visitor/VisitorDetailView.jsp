...
<%@page import="com.stone.visitor.common.Visitor"%>
...
<h1 align="center" style="padding-top: 35px; padding-bottom: 15px">방명록 상세페이지</h1>
	<form action="/visitorUpdate?no=<%=visitor.getNo() %>" method="post">
	...
	<tr>
		...
		<td align="left"> &nbsp;<%=visitor.getNo()%></td>
	</tr>
	<tr>
		<td align="center" bgcolor="#9db589" width="70">제목</td>
		<td align="left"> 
		<input type="text" name="title" size="80" style="margin-left: 4px" value="<%=visitor.getTitle()%>"/>
		</td>
	</tr>
	<tr>
		<td align="center" bgcolor="#9db589" width="70">내용</td>
		<td align="left">
		<input type="text" name="contents" size="80" style="margin-left: 4px" value="<%=visitor.getContents() %>"/>
		</td>
	</tr>
	<tr>
		<td align="center" bgcolor="#9db589" width="70">닉네임</td>
		<td align="left"> 
		<input type="text" name="nickname" size="80" style="margin-left: 4px" value="<%=visitor.getNickname()%>"/>
	</td>
	<tr>
		<td align="center" bgcolor="#9db589" width="70">작성자</td>
		<td align="left"> &nbsp;<%=visitor.getMember_no().getName()%>
	</td>
	<tr>
		<td align="center" bgcolor="#9db589" width="70">날짜</td>
		<td align="left"> &nbsp;<%=visitor.getRdate()%>
	</td>
	</tr>
...
%>
	...
	<a onclick="location.href='/visitorDelete?no=<%=visitor.getNo() %>'">
