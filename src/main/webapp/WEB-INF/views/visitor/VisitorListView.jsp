...
%>	
	<!-- 게시물목록출력 -->
	<h1 align="center" style="padding-top: 35px; padding-bottom: 15px">방명록 목록</h1>
	<table cellpadding="1" cellspacing="1" width="700" 
		...
		<td align="center">
		<a href="/visitorAdd/<%=visitor.getNo() %>"><%=visitor.getTitle()%></a>
		</td>
		<td align="center">
			<%=visitor.getNickname()%>
		</td>
...
<button style="margin-top: 10px;" onclick="location.href='/visitorAdd'">새글등록</button>
