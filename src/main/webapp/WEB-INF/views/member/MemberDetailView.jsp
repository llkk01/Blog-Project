...
<!-- aside 가운데 본문 영역 -->
	<section id="center">
		<div id="divcenter">
			<br><br><br>
			<h2 align="center">회원정보 상세</h2><br>
			<section style="text-align: left; margin-left: 320px; letter-spacing: 5px;">
			번호<br><input type="text" value="<%=member.getNo()%>"> <br>
			이름<br><input type="text" value="<%=member.getName()%>"> <br>
			아이디<br><input type="text" value="<%=member.getId()%>"> <br>
			비밀번호<br><input type="password" value="<%=member.getPassword()%>"> <br>
			우편번호<br><input type="text" value="<%=member.getId()%> "> <br>
			주소<br><input type="text" value="<%=member.getId()%>"> <br>
			상세주소<br><input type="text" value="<%=member.getId()%>"> <br><br>
			</section>
			<a href="/memberList" id="ano">목록으로</a>
